...
setLan( "ChatRemoveWhitelistAll", "You removed whitelist all to %s (%s) !" )
setLan( "ChatGetRemoveWhitelist", "You get unwhitelisted of %s by %s (%s) !" )
setLan( "ChatGetRemoveWhitelistAll", "You get unwhitelisted all by %s (%s) !" )
setLan( "ChatAddWhitelist", "You added whitelist of %s to %s (%s) !" )
setLan( "ChatAddWhitelistAll", "You added whitelist all to %s (%s) !" )
setLan( "ChatGetAddWhitelist", "You get whitelisted of %s by %s (%s) !" )
setLan( "ChatGetAddWhitelistAll", "You get whitelisted all by %s (%s) !" )
...
setLan( "PanelUnwhitelistedAll", "%s has been unwhitelisted all !" )
...
setLan( "PanelWhitelistedAll", "%s has been whitelisted all !" )
