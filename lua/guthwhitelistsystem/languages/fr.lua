...
setLan( "WhitelistAll", "Whitelist All" )
...
setLan( "ChatRemoveWhitelistAll", "Vous avez enlevé la Whitelist All à %s (%s) !" )
setLan( "ChatGetRemoveWhitelist", "Vous avez été enlevé de la liste blanche de %s par %s (%s) !" )
setLan( "ChatGetRemoveWhitelistAll", "Vous avez été enlevé de la Whitelist All par %s (%s) !" )
setLan( "ChatAddWhitelist", "Vous avez ajouté la liste blanche de %s à %s (%s) !" )
setLan( "ChatAddWhitelistAll", "Vous avez ajouté la Whitelist All à %s (%s) !" )
setLan( "ChatGetAddWhitelist", "Vous avez été ajouté à la liste blanche de %s par %s (%s) !" )
setLan( "ChatGetAddWhitelistAll", "Vous avez été ajouté à la Whitelist All par %s (%s) !" )
...
setLan( "PanelUnwhitelistedAll", "%s a été enlevé de la Whitelist All !" )
...
setLan( "PanelWhitelistedAll", "%s a été ajouté à la Whitelist All !" )
