...
setLan( "WhitelistRemove", "Enlever de la liste blanche" )
setLan( "WhitelistAdd", "Ajouter à la liste blanche" )
setLan( "DesactivateWhitelist", "Désactiver la liste blanche" )
setLan( "DesactivateVIP", "Désactiver le VIP" )

setLan( "ChatRemoveWhitelist", "Vous avez enlevé la liste blanche de %s à %s (%s) !" )
setLan( "ChatGetRemoveWhitelist", "Vous avez été enlevé de la liste blanche de %s par %s (%s) !" )
setLan( "ChatAddWhitelist", "Vous avez ajouté la liste blanche de %s à %s (%s) !" )
setLan( "ChatGetAddWhitelist", "Vous avez été ajouté à la liste blanche de %s par %s (%s) !" )
